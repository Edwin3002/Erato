...
<nav className=" bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-red-500">
  ...
  <div className="flex md:order-2">
    <button type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className="md:hidden  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600 rounded-lg text-sm p-2.5 mr-1">
    ...
    <div className="hidden relative md:block">
      ...
      <input type="text" id="search-navbar" className="block p-2 pl-10 w-full bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-400 dark:border-gray-600 dark:placeholder-gray-200 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
    </div>
    ...
    <div className={`justify-between items-center w-full md:flex md:w-auto md:order-1 ${btnNav ? '' : 'hidden'}`} id="navbar-search">
      ...
      <ul className="flex flex-col p-2 mt-4  rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 ">
        ...
        <li>
          <Link href="/contacto">
          <a  className="block py-2 pr-4 pl-3  rounded   md:p-2 hover:bg-gray-400 focus:bg-gray-400" aria-current="page">Contacto</a>
          </Link>
        </li>
      </ul>
    </div>
