    ...
    <div >
      <article className='md:flex w-full h-screen'>
        <section className='w-full md:w-3/4 h-1/2 md:h-3/4 p-4'>
          <iframe className='w-full min-h-[350px] md:min-h-[700px] rounded-lg' src="https://www.youtube.com/embed/ARDaOC7Pxmo" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
        </section>
        <section className='w-full md:w-1/4 h-5/6'>
          <h1 className='text-center text-4xl text-bold my-4'>Lista de cursos</h1>
          <ul className=' flex flex-col justify-around h-1/2 md:h-3/4'>
            <li className='flex'>
